from web.events import emit_task_created, emit_task_updated, emit_task_deleted, emit_blocked_slot_created, emit_blocked_slot_deleted, emit_blocked_slot_toggled
from shared.storage.database import connect_db
from shared.services.service import (create_user_task, complete_task, reagendar_user_task, delete_task)
from shared.storage.task_store import  actualizar_nombre_tarea, actualizar_tipo_tarea, crear_horario_bloqueado, toggle_horario_bloqueado
from web.routes.calendar import obtener_tareas_db
from shared.utils.helpers import get_user_tel_from_state
