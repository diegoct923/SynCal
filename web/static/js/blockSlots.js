...
function openBlockedSlotsModal() {
  ...
  openCustomModal(
    ...
    `
      ...
      <input id="blockedHourInput" type="time" step="1800" value="08:00">
    ...
    () => {
      ...
      const hour = timeToDecimal(document.getElementById("blockedHourInput").value);
      ...
      if (!document.getElementById("blockedHourInput").value ||
          Number.isNaN(hour) ||
          hour < 0 ||
          hour > 23.5) {         
